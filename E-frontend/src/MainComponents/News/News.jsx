  ...
  return (
    <div className="min-h-screen bg-black text-white p-4">
      <div className="max-w-8xl mx-auto md:p-4 p-6">
        ...
        {/* TOP BAR */}
        <div className="flex justify-between items-center px-5 py-3 rounded-xl shadow-lg">
        ...
        <Link
          to="/news"
          className="h-16 flex justify-center items-center mt-8 text-blue-500 font-semibold hover:underline cursor-pointer"
        >
          More News
        </Link>
      </div>
