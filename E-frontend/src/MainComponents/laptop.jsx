...
const Laptop = () => {
     ...
     const [filters, setFilters] = useState({
          ...
          brand: [],
          ram: [],
          storage: [], // Laptops usually use "storage" instead of "rom"
          rating: [],
          discount: [],
     });
     ...
     const dynamicFilterOptions = {
          ...
          ram: [
               ...new Set(
                    products.map((p) => p.specifications?.ram).filter((v) => v && v !== "")
               ),
          ],
          storage: [
               ...new Set(
                    products
                         .map((p) => p.specifications?.storage)
                         .filter((v) => v && v !== "")
               ),
          ],
     };
          ...
          <div className="flex flex-col lg:flex-row bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#0a0a2e] via-[#020617] to-[#05051a] text-white min-h-screen mt-16 lg:mt-20 relative ">
               ...
               >
                    <div className="flex items-center justify-between mb-5">
                         <h2 className="text-xl font-semibold underline text-cyan-200">
                              Filters
                         </h2>
                         ...
                         <button
                              className="hidden lg:block text-base text-red-500 hover:underline "
               ...
               <div className="w-full p-4 lg:p-6 flex-1">
                    ...
                    {filteredProducts.length === 0 ? (
                         ...
                         filteredProducts.map((product) => (
                              <article
                                   key={product._id}
                                   className="bg-cyan-900/10 border border-cyan-900/30 p-4 mb-4 rounded-lg shadow-lg hover:shadow-cyan-900/20 transition-all group"
                              >
                                        ...
                                        <div className="flex-1">
                                             ...
                                             <div className="grid grid-cols-2 gap-x-4 gap-y-1 mt-4 text-sm  text-gray-300">
                                                  ...
                                                  {product.specifications?.processor && (
                                                       <p className="truncate">
                                                            <span className="text-teal-600">Processor:</span>{" "}
                                                            {product.specifications.processor}
                                                       </p>
                                                  )}
                                                  ...
                                                  {product.specifications?.battery && (
                                                       <p className="truncate">
                                                            <span className="text-pink-500">Battery:</span>{" "}
                                                            {product.specifications.battery}
                                                       </p>
                                                  )}
                                                  {product.specifications?.graphics && (
                                                       <p className="truncate">
                                                            <span className="text-pink-500">Graphics:</span>{" "}
                                                            {product.specifications.graphics}
                                                       </p>
                                                  )}
