...
const Gadgets = () => {
     ...
     // Auto-generate dynamic filters
     const dynamicFilterOptions = {
          brand: [...new Set(products.map((p) => p.brand).filter(Boolean))],
          type: [
               ...new Set(
                    products
                         .map((p) => p.specifications?.type)
                         .filter((v) => v && v !== "")
               ),
          ],
     };
     ...
     const filterOptions = {
          ...
          discount: ["10% off", "20% off", "30% off", "40% off"],
     ...
     useEffect(() => {
          ...
          if (filters.type.length > 0) {
               filtered = filtered.filter((p) =>
                    filters.type.includes(p.specifications?.type)
               );
          }
                                        ...
                                        <div className="flex-1">
                                             ...
                                             <div className="grid grid-cols-2 gap-x-4 gap-y-1 mt-4 text-sm  text-gray-300">
                                                  ...
                                                  {product.specifications?.os && (
                                                       <p className="truncate"><span className="text-pink-500">OS:</span> {product.specifications.os}</p>
                                                  )}
                                             ...
                                             <div className="flex flex-col items-end gap-3 mt-2">
                                                  <div className="text-pink-500 text-xs font-medium">
                                                       {(() => {
                                                            ...
                                                            return available > 0 ? `In Stock: ${available}` : "Sold Out";
                                                       })()}
                                                  </div>
